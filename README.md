...
- 題目／概念級確定性間隔複習、今日／逾期佇列、容易答錯概念、分類複習、未來七天負荷、Asia/Taipei 學習日與連續天數。
...
人工課程位於 `content/lessons/`，每日流程不得修改。每日研究候選按 OpenAlex、Europe PMC、Crossref、Semantic Scholar fallback 取得；獨立自動回補流程每日聚合四個來源，每批最多新增 10 篇，直到研究庫累積 100 篇，並兼顧分類覆蓋與預印本比例。候選通過英文內容、必要 metadata、心理學相關性、去重、確定性排名、Crossref 核對與合法公開版本檢查後，才交由 LLM 整理。
...
- 研究庫由獨立排程逐批擴充至 100 篇；候選品質不足時可能擴大到最近 365 天，連續無進展後會停止並要求人工檢查。
