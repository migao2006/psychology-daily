...
import { researchArticleSchema } from "@/lib/schemas/research";
...
import seedResearch from "@/content/research/items/10-1007-s40489-026-00579-5.json";
...
describe("research selection rules", () => {
  ...
  it("validates HTTPS and preprint research JSON", () => {
    ...
    const seed = researchArticleSchema.parse({ ...seedResearch, publicationStatus: "preprint" });
